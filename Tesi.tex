...
\usepackage[a4paper,top=3cm,bottom=4cm,left=2cm,right=2cm,marginparwidth=2cm]{geometry}
...
\input{Capitoli/casiduso}
\input{Capitoli/Tecnologie Abilitanti}
\input{Capitoli/Sviluppo funzionalità}
\input{Capitoli/Dimostrazioni d'uso}
