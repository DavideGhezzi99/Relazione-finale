...
\end{figure}
\hspace{-0.6cm}La scena rappresentata nella \textbf{Figura 5.4} è quella caricata dall'applicazione dell'utente se è stato effettuato l'accesso come studente.
